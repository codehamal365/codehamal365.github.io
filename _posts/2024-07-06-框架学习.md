...
容器化是一种将应用程序及其所有依赖项打包到轻量级、可移植容器中的技术。它允许应用程序在任何环境中一致运行，提高了部署效率和可扩展性。Kubernetes (K8s) 是最流行的容器编排平台，用于自动化部署、扩展和管理容器化应用程序。

### Kubernetes

Kubernetes 是一个开源的容器编排平台，用于自动化部署、扩展和管理容器化应用程序。它提供了强大的功能，如服务发现、负载均衡、自动扩展和自我修复。

- [云原生 Java 架构师的第一课 K8s + Docker + KubeSphere + DevOps 视频教程](https://www.bilibili.com/video/BV13Q4y1C7hS)
- [Kubernetes（k8s）入门到实战教程丨全新升级完整版](https://www.bilibili.com/video/BV1GT4y1A756)

**使用案例**: 在微服务架构中，Kubernetes 可以管理多个服务实例，确保高可用性和负载均衡。例如，一个电商网站可以使用 K8s 来部署前端、后端和数据库服务。
...
- [深圳地铁大数据客流分析系统](https://gitee.com/geekyouth/SZT-bigdata)
- [大数据项目之 Flink 实时数仓 3.0（抢先版）-上](https://www.bilibili.com/video/BV1PA4y1S7Yz)
- [大数据项目之 Flink 实时数仓 3.0（抢先版）-下](https://www.bilibili.com/video/BV1oY4y1t7GB)
...
- [大数据 Apache Doris 教程](https://www.bilibili.com/video/BV15S4y1h7Kt)
...
- [Greenplum 集群安装配置及最佳实践(官方版)](https://www.bilibili.com/video/BV1XJ411L7Gv)
...
- [Hudi 中文文档](https://hudi.apache.org/cn/docs/next/overview)
...
- [StarRocks 官网](https://docs.starrocks.io/zh-cn/latest/introduction/StarRocks_intro)
...
- [Dinky 官网](https://www.dlink.top/docs/intro)

### 5.4 Dolphinscheduler
...
- [StreamPark 官网](https://streampark.apache.org/zh-CN/docs/intro/)

### 5.7 TIS

- [基于 DataX 和 Flink-CDC 的 DataOps 数据同步中台 TIS](https://tis.pub/docs/)

## 6 数据集成

### 6.1 Debezium

- [Debezium 官网](https://debezium.io/documentation/reference/2.0/)
