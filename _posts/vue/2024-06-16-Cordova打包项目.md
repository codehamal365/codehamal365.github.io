...
Cordova 使用插件来访问设备功能，如相机、位置等。

常用插件:

- cordova-plugin-camera: 用于访问设备相机。

  安装: cordova plugin add cordova-plugin-camera
...
- 白屏问题: 确保 www/index.html 存在，设置 <base href="./">

- 构建失败: 检查 JDK, Android SDK 版本，更新 Cordova。

- 跨域问题: 在 config.xml 中设置 <access origin="*"> 或使用代理。
