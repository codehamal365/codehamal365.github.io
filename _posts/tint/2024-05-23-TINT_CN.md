...
这种无缝集成提高了内容管理的效率，使品牌能够专注于创意策略而非手动上传。

## 1. 从社交媒体上汇总UGC内容

当您登录到TINT后，您可以选择要检索UGC内容的社交媒体。在选择媒体之后，搜索对应的UGC内容，人工过滤选择合适的内容后，将内容添加到TINT的UGC Studio，最后发布到DAM平台。

TINT 支持从 Instagram、Facebook、Twitter、TikTok、YouTube 和 Pinterest 等平台聚合内容，实现全面的 UGC 收集。
...
例如，输入如 '#BrandCampaign' 的标签或与您的产品相关的关键词，以筛选并找到最相关的 UGC。
...
此过程涉及 TINT 联系内容创建者获取许可，确保合法使用并与您的受众建立信任。
...
这种简化的工作流程通过消除手动下载和上传来提高生产力，确保所有权利批准的内容随时可在您的 DAM 中获取。
